...
document.getElementById("yesbutton").addEventListener("click", function() {
    ...
    document.getElementById("yesModalText").textContent = "I love youuu❤️! See you soon!";
});
...
const funnyResponses = [
    { text: "Last chance?🥺", img: "Sad.gif" },
    { text: "Sure ka na?🥹", img: "sad2.gif" },
    { text: "iyak ako sigi ka 😭", img: "sad6.gif" },
    { text: "ako na to oh 😚", img: "sad3.gif" },
    { text: "Yes mo na tas kiss😌", img: "sad4.gif" },
